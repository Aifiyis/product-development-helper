...
class CompetitorProduct(db.Model):
    ...
    platform = db.Column(db.String(30), nullable=False, default="unknown", index=True)
    title = db.Column(db.String(500), nullable=True)
    price = db.Column(db.String(80), nullable=True)
    previous_price = db.Column(db.String(80), nullable=True)
    previous_collected_at = db.Column(db.DateTime, nullable=True)
